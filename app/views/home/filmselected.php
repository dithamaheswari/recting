    ...
    <!-- header-->
                ...
                <div style="width: 1417px; height: 429.67px; position: relative">
                        <div style="width: 951.30px; height: 429.67px; left: 0px; top: 0px; position: absolute">
                            ...
                            src="https://www.youtube.com/embed/zSWdZVtXT7E?autoplay=1&mute=1"
                            ...
                            <img style="width: 298.87px; height: 429.67px; left: 652.43px; top: -0px; position: absolute; border: 1px solid" src="<?= isset($data['movieDetails']) ? $data['movieDetails']['thumbnail'] : ''; ?>http://localhost/recting/public/assets/img/thumbnails/download.jpeg" />
                        </div>
                        <div style="width: 428px; height: 324.35px; left: 989px; top: 0.49px; position: absolute">
                            ...
                            <div style="width: 424.15px; height: 62.66px; left: 3.50px; top: 67.69px; position: absolute">
                                ...
                                <div style="width: 34.28px; height: 32.65px; left: 0px; top: 0.65px; position: absolute;"><svg width="36" height="33" viewBox="0 0 36 33" fill="none" xmlns="http://www.w3.org/2000/svg">
                                ...
                                <div style="width: 233px; height: 38px; left: 191.15px; top: 24.66px; position: absolute; color: white; font-size: 16px; font-family: Inter; font-weight: 400; line-height: 24px; word-wrap: break-word"> <p>Sutradara :  <?= isset($data['movieDetails']) ? $data['movieDetails']['producer'] : ''; ?>Christopher Nolan</p></div>
                                <div style="width: 216.42px; height: 19.03px; left: 190.73px; top: 0px; position: absolute; color: white; font-size: 16px; font-family: Inter; font-weight: 400; line-height: 24px; word-wrap: break-word"> <p> <?= isset($data['movieDetails']) ? $data['movieDetails']['year_release'] : ''; ?>2014</p></div>
                            </div>
                            <div style="width: 283.81px; height: 45.98px; left: 0px; top: 0px; position: absolute; color: white; font-size: 32px; font-family: Inter; font-weight: 400; line-height: 58px; word-wrap: break-word"> <h2><?= isset($data['movieDetails']) ? $data['movieDetails']['title'] : ''; ?>INTERSTELLAR</h2></div>
                            </div>
                            ...
                            <div style="width: 410.65px; height: 88.91px; color: white; font-size: 16px; font-family: Inter; font-weight: 400; line-height: 19px; word-wrap: break-word"> <p> <?= isset($data['movieDetails']) ? $data['movieDetails']['sinopsis'] : ''; ?>When Earth becomes uninhabitable in the future, a farmer and ex-NASA pilot, Joseph Cooper, is tasked to pilot a spacecraft, along with a team of researchers, to find a new planet for humans.</p></div>
                            <div style="width: 411px; height: 30px; color: white; font-size: 16px; font-family: Inter; font-weight: 400; line-height: 19px; word-wrap: break-word"> <p>Genre :   <?= isset($data['movieDetails']) ? $data['movieDetails']['rating'] : ''; ?>Petualangan , Drama , Sci-Fi</p></div>
                            <div style="width: 411px; height: 41px; color: white; font-size: 16px; font-family: Inter; font-weight: 400; line-height: 19px; word-wrap: break-word"> <p>Aktor :   <?= isset($data['movieDetails']) ? $data['movieDetails']['actor'] : ''; ?>Matthew McConaughey , Anne Hathaway , Jessica Chastain</p></div>
                            </div>
                        </div>
                        </div>
